  ...
  return (
    <div className='flex justify-between w-11/12 max-w-[1160px] py-12 mx-auto gap-x-12 gap-y-0'>
        <div className='w-11/12 max-w-[450px] mx-0'>
            ...
            font-semibold text-[1.87rem] leading-[2.375rem]'>{title}</h1>
            <p className='text-[1.125rem] leading[1.65rem] mt-4'>
        ...
        <div className='relative w-11/12 max-w-[450px]'>
            ...
            <img className='absolute -top-4 right-4' src={image} alt="above-img" width={558} height={490} loading="lazy"/>
        </div>
    </div>
  )
}
